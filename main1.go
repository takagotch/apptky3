      ...
      <body>
        <div class='container'>
          <div class='section friendly'>
            <h1><strong>TKVTV | Created by takagotch! </strong></h1>
            <div class='article'>
              <p>Refer to the <a href="//tkvtv.com/">documentation</a> if you need help deploying.</p>
            </div>
          </div>
        </div>
      </body>
...
funcmain() {
  ...
  http.Handle("/staitc/", http.StripPrefix("/static/", http.FileServer(http.Dir("/etc/gohttpserver/doc"))))
